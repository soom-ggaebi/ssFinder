...
import 'package:sumsumfinder/widgets/found/custom_switch.dart';
                        ...
                        children: [
                          ...
                          CustomSwitch(
                            ...
                            onChanged: (newValue) async {
                              // newValue가 true면 "STORED", false면 "RECEIVED"
                              final newStatus =
                                  newValue ? "STORED" : "RECEIVED";
                              try {
                                ...
                                setState(() {
                                  _foundItem = item.copyWith(status: newStatus);
                                });

                                ScaffoldMessenger.of(context).showSnackBar(
                                  SnackBar(
                                    content: Text(
                                      '상태가 "${newStatus == "STORED" ? "찾는 중" : "찾음"}"으로 변경되었습니다.',
                                    ),
                                  ),
                                );
                              } catch (e) {
