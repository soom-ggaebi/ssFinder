...
public class LostItemController {
    ...
    @GetMapping
    public ApiResponse<List<LostItemListResponse>> getLostAll(@AuthenticationPrincipal CustomUserDetails userDetails) {
        List<LostItemListResponse> lostItemList = lostItemService.getLostAll(userDetails.getUserId());
